...
if(isset($_GET['search'])){
    ...
    if(isset($_GET['id'])){
        $id=$_GET['id'];
        $x=mysqli_query($conn,"SELECT * FROM `entrysrchemicals` WHERE id='$id'");
        ...
        else
        {
            ...
            if($sql)
            {
                ...
                <div class="jn"><a href="viewsrchemicals.php" name="yes" class="fg14" style="margin-top:10px; position:absolute; right:24%; top:70%;">Go Back</a></div>
