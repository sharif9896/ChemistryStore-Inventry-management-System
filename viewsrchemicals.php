...
if(isset($_GET['id'])){
	$d=$_GET['id'];
	$sql=mysqli_query($conn,"DELETE FROM `entrysrchemicals` WHERE id='$d'");
	if($sql)
	{
		?>
...
<div class="navss">
    ...
    <span class="subhead"><center><h3>Total Stocks of SR Chemicals</h3></center></span>
...
if(isset($_GET['search'])){
    $filter=$_GET['search'];
    $filter2="SELECT * FROM `entrysrchemicals` WHERE CONCAT(Brand,Quantity,Rate,mlkg,Name) LIKE '%$filter%'";
    ...
    if(mysqli_fetch_array($filtrow) > 0){
        foreach($filtrow as $row){
            ?>
                ...
                <td><a href="update2.php?id=<?php echo $row['id'];?>" class="fg1" style="color: white; text-align:center; margin-left:10px;">Update</a></td>
                <td><a href="cart2.php?id=<?php echo $row['id'];?>"class="fg14" style="color: white; text-align:center; margin-left:10px;">+ Cart</a></td>
                <td><a href="viewsrchemicals.php?id=<?php echo $row['id'];?>" class="fe2" style="color: white;  padding: 10px 10px; font-size: 15px; text-align:center; margin-left:10px;">Remove</a></td>
            </tr>
            <?php
        }
    }
...
$i=1;
$x=mysqli_query($conn,"SELECT * FROM `entrysrchemicals`");
...
<td><a href="update2.php?id=<?php echo $y['id'];?>" class="fg1" style="color: white; text-align:center; margin-left:10px;">Update</a></td>
<td><a href="cart2.php?id=<?php echo $y['id'];?>"class="fg14" style="color: white; text-align:center; margin-left:10px;">+ Cart</a></td>
<td><a href="viewsrchemicals.php?id=<?php echo $y['id'];?>" class="fe2" style="color: white;  padding: 10px 10px; font-size: 15px; text-align:center; margin-left:10px;">Remove</a></td>
</tr>
<?php }
 }?>
</table>
<button id="back-to-top" onclick="topFunction()" title="Go to top">&#8679;</button>
    ...
    <center><h5><a href="http://localhost/CHEMISTRYSTORE/viewsrchemicals.php">ALL</a></h5></center>
    </div>
