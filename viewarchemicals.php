...
if(isset($_GET['id'])){
	$d=$_GET['id'];
	$sql=mysqli_query($conn,"DELETE FROM `entryarchemicals` WHERE id='$d'");
	if($sql)
	{
		?>
...
<div class="navss">
    ...
    <span class="subhead"><center><h3>Total Stocks of AR Chemicals</h3></center></span>
...
if(isset($_GET['search'])){
    $filter=$_GET['search'];
    $filter2="SELECT * FROM `entryarchemicals` WHERE CONCAT(Brand,Quantity,Rate,mlkg,Name) LIKE '%$filter%'";
    ...
    if(mysqli_fetch_array($filtrow) > 0){
        foreach($filtrow as $row){
            ...
            <tr style="font-size:20px;color:black; text-align: left;">
                ...
                <td><a href="update1.php?id=<?php echo $row['id'];?>" class="fg1" style="color: white; text-align:center; margin-left:10px;">Update</a></td>
                <td><a href="cart1.php?id=<?php echo $row['id'];?>"class="fg14" style="color: white; text-align:center; margin-left:10px;">+ Cart</a></td>
                <td><a href="viewarchemicals.php?id=<?php echo $row['id'];?>" class="fe2" style="color: white;  padding: 10px 10px; font-size: 15px; text-align:center; margin-left:10px;">Remove</a></td>
            </tr>
            <?php
        }
    }
...
$i=1;
$x=mysqli_query($conn,"SELECT * FROM `entryarchemicals`");
while($y=mysqli_fetch_array($x))
{
  ...
  <td><?php echo "<img src='$y[Image]'  height=80px width=80px />" ;?></td>
                ...
                <td><a href="update1.php?id=<?php echo $y['id'];?>" class="fg1" style="color: white; text-align:center; margin-left:10px;">Update</a></td>
                <td><a href="cart1.php?id=<?php echo $y['id'];?>"class="fg14" style="color: white; text-align:center; margin-left:10px;">+ Cart</a></td>
                <td><a href="viewarchemicals.php?id=<?php echo $y['id'];?>" class="fe2" style="color: white;  padding: 10px 10px; font-size: 15px; text-align:center; margin-left:10px;">Remove</a></td>
            </tr>
<?php }
 }?>
</table>
<button id="back-to-top" onclick="topFunction()" title="Go to top">&#8679;</button>
    ...
    <center><h5><a href="http://localhost/CHEMISTRYSTORE/viewarchemicals.php">ALL</a></h5></center>
    </div>
