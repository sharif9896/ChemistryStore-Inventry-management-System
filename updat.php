...
<?php }
 ?>
        ...
        <div class="kol">
            <div class="sign">
            <span class="subhead"><center><h3>Take Apparatus</h3></center></span>
    <center>
...
if(isset($_POST['register']))
{
    ...
    if($nam==NULL || $Quan==NULL ||$rat==NULL || $mlk==NULL || $brd==NULL)
    {
        //
    }
    else
    {
        ...
        // $folder="images/".$filename;
        // move_uploaded_file($temp_nam, $folder); 
        $sql=mysqli_query($conn,"INSERT INTO `protaken`(`Brand`, `Quantity`, `mlkg`, `Rate`, `Date`, `Time`,`Name`,`Regno`,`stud`) VALUES ('$brd','$Quan','$mlk','$rat',NOW(),NOW(),'$nam','$roll','$nm')");
        if($sql)
        {
            ?>
...
<center><h7><a href="http://localhost/CHEMISTRYSTORE/viewaapa.php" style="color:#303030; font-size: 12px;">Go Back To Check The Product To Take</a></h7></center>

<center><h7><a href="http://localhost/CHEMISTRYSTORE/mycart.php" style="color:#303030; font-size: 12px;">Go Back</a></h7></center>
            </div>
        </div>
