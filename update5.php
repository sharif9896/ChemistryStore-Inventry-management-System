...
$sql=mysqli_query($conn,"SELECT * FROM `2ndbsc(c)` WHERE id LIKE '$id'");
...
if(isset($_POST['register']))
{
    ...
    {
        $sql=mysqli_query($conn,"UPDATE `2ndbsc(c)` SET `Name`='$nam',`Regno`='$roll',`Class`='$cls',`Phone`='$deg' WHERE id LIKE '$id'");
        if($sql)
        {
            ?>
...
<center><h7><a href="http://localhost/CHEMISTRYSTORE/IIbsc(c)view.php" style="color:#303030; font-size: 12px;">Go Back</a></h7></center>
            </div>
        </div>
