...
if(isset($_GET['search'])){
    ...
    if(isset($_GET['id'])){
        $id=$_GET['id'];
        $x=mysqli_query($conn,"SELECT * FROM `entryarchemicals` WHERE id='$id'");
        ...
        else
        {
            ...
            if($sql)
            {
              ...
              <div class="mi" data-aos="fade-up" style="color:#303030; font-size: 30px;  background-color:white; border: 1px solid #303939; padding-top:80px; width:  600px;  height: 350px; margin-top: 15%; padding-left: 0%; padding-right: 0%;">
                ...
                <div class="jn"><a href="viewarchemicals.php" name="yes" class="fg14" style="margin-top:10px; position:absolute; right:24%; top:70%;">Go Back</a></div>
