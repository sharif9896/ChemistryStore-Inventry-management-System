...
<?php }
 ?>
        ...
        <div class="kol">
            <div class="sign">
            <span class="subhead"><center><h3>Update LR Chemicals</h3></center></span>
    <center>
...
$sql=mysqli_query($conn,"SELECT * FROM `entrylrchemicals` WHERE id LIKE '$id'");
...
if(isset($_POST['register']))
{
    ...
    foreach($sql as $full){
        ...
        $sql=mysqli_query($conn,"UPDATE `entrylrchemicals` SET `Brand`='$brd',`Quantity`='$Quan',`mlkg`='$ml',`Rate`='$rat',`Name`='$nam',`Image`='$oldimg' WHERE id LIKE '$id'");
        if($sql)
        {
            ?>
    ...
    if(isset($_POST['register']))
{
    ...
    else 
    {
        ...
        $sql=mysqli_query($conn,"UPDATE `entrylrchemicals` SET `Brand`='$brd',`Quantity`='$Quan',`mlkg`='$ml',`Rate`='$rat',`Name`='$nam',`Image`='$folder' WHERE id LIKE '$id'");
        if($sql)
        {
            ?>
            <div class="mi" style="color:#303030; font-size: 13px;">Updated Successfully!</div>
...
<tr><td class="labelsss">Product Image :</td><td><input type="file" name="imga" class="fields" size="25" value="Choose File" /></td></tr>
<tr><td colspan="2" align="center"><input type="submit" value="Update" name="register" class="fields fg" /></td></tr>
</table>
</form>
<center><h7><a href="http://localhost/CHEMISTRYSTORE/viewlrchemicals.php" style="color:#303030; font-size: 12px;">Go Back</a></h7></center>
            </div>
        </div>
