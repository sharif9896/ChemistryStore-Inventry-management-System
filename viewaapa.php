...
if(isset($_GET['id'])){
	$d=$_GET['id'];
	$sql=mysqli_query($conn,"DELETE FROM `entryproducts` WHERE id='$d'");
	if($sql)
	{
		?>
...
<div class="navss">
    ...
    <span class="subhead"><center><h3>Total Stocks of Apparatus</h3></center></span>
...
<table border="1" style="background: white;  margin-top:30px;" cellpadding="5" cellspacing="5" class="design" align="" >
    ...
    if(mysqli_fetch_array($filtrow) > 0){
        foreach($filtrow as $row){
            ?>
                ...
                <td><a href="update.php?id=<?php echo $row['id'];?>" class="fg1" style="color: white; text-align:center; margin-left:10px;">Update</a></td>
                <td><a href="cart.php?id=<?php echo $row['id'];?>"class="fg14" style="color: white; text-align:center; margin-left:10px;">+ Cart</a></td>
                <td><a href="viewaapa.php?id=<?php echo $row['id'];?>" class="fe2" style="color: white;  padding: 10px 10px; font-size: 15px; text-align:center; margin-left:10px;">Remove</a></td>
                </tr>
            <?php
        }
    }
...
<td><a href="update.php?id=<?php echo $y['id'];?>" class="fg1" style="color: white; margin-right: 30px; text-align:center; margin-left:10px;">Update</a></td>
<td><a href="cart.php?id=<?php echo $y['id'];?>"class="fg14" style="color: white; text-align:center; margin-left:10px;">+ Cart</a></td>
<td><a href="viewaapa.php?id=<?php echo $y['id'];?>" class="fe2" style="color: white;  padding: 10px 10px; font-size: 15px; text-align:center; margin-left:10px;">Remove</a></td>
<!-- <td><a href="cart.php?id=<?php echo $y['id'];?>" class="fg14" style="color: white;">Add To Cart</a></td>td -->
 <!-- <td><input type="hidden" name="id" value="<?php echo $y['id']?>" class="fg14" style="color: white; width: 100px; border:none;"></td>
...
<button id="back-to-top" onclick="topFunction()" title="Go to top">&#8679;</button>
    ...
    <center><h5><a href="http://localhost/CHEMISTRYSTORE/viewaapa.php">ALL</a></h5></center>
    </div>
