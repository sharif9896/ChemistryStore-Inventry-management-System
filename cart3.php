...
<table  style="background: white;  margin-top:30px; margin-left: 10px;" cellpadding="5" cellspacing="5" class="design" align="" >
...
if(isset($_GET['search'])){
    ...
    if(isset($_GET['id'])){
        $id=$_GET['id'];
        $x=mysqli_query($conn,"SELECT * FROM `entrylrchemicals` WHERE id='$id'");
        ...
        else
        {
            ...
            if($sql)
            {
                ...
                <div class="jn"><a href="viewlrchemicals.php" name="yes" class="fg14" style="margin-top:10px; position:absolute; right:24%; top:70%;">Go Back</a></div>
