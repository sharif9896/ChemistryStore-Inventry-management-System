...
<?php }
 ?>
        ...
        <div class="kol">
            <div class="sign">
            <span class="subhead"><center><h3>Update AR Chemicals</h3></center></span>
    <center>
...
$sql=mysqli_query($conn,"SELECT * FROM `entryarchemicals` WHERE id LIKE '$id'");
...
if(isset($_POST['register']))
{
    ...
    foreach($sql as $full){
        ...
        $sql=mysqli_query($conn,"UPDATE `entryarchemicals` SET `Brand`='$brd',`Quantity`='$Quan',`mlkg`='$ml',`Rate`='$rat',`Name`='$nam',`Image`='$oldimg' WHERE id LIKE '$id'");
        if($sql)
        {
            ?>
    ...
    if(isset($_POST['register']))
{
    ...
    else 
    {
        ...
        $sql=mysqli_query($conn,"UPDATE `entryarchemicals` SET `Brand`='$brd',`Quantity`='$Quan',`mlkg`='$ml',`Rate`='$rat',`Name`='$nam',`Image`='$folder' WHERE id LIKE '$id'");
        if($sql)
        {
            ?>
            <div class="mi" style="color:#303030; font-size: 13px;">Updated Successfully!</div>
...
// }
?></td></tr>
<tr><td class="labelsss">Product Name :</td><td><input type="text" required="required" name="nam" class="fields" size="25" value="<?php echo $row['Name']?>" /></td></tr>
...
<tr><td class="labelsss">Product Image :</td><td><input type="file" name="imga" class="fields" size="25" value="<?php echo  $row['Image']?>" /></td></tr>
<tr><td colspan="2" align="center"><input type="submit" value="Update" name="register" class="fields fg" /></td></tr>
</table>
</form>
<center><h7><a href="http://localhost/CHEMISTRYSTORE/viewarchemicals.php" style="color:#303030; font-size: 12px;">Go Back</a></h7></center>
            </div>
        </div>
