...
<div class="navss">
    ...
    <div class="side-bar">
        ...
        <div class="hom"> <a href="http://localhost/CHEMISTRYSTORE/entryARchemicals.php"><i class="fas fa-eye"></i>AR Cemicals</a></div>
...
<?php }
 ?>
        ...
        <div class="kol">
            <div class="sign">
            <span class="subhead"><center><h3>Entry Chemicals</h3></center></span>
    <center>
...
if(isset($_POST['register']))
{
    ...
    {
        $sql=mysqli_query($conn,"INSERT INTO `entryarchemicals`(`Brand`, `Quantity`, `mlkg`, `Rate`, `Name`,`Image`) VALUES (' $brd','$Quan','$ml','$rat','$nam','$folder')");
        if($sql)
        {
            ?>
...
if(isset($_POST['registers']))
{
    ...
    {
        $sql=mysqli_query($conn,"INSERT INTO `entryLRchemicals`(`Brand`, `Quantity`, `mlkg`, `Rate`, `Name`,`Image`) VALUES (' $brd','$Quan','$ml','$rat','$nam','$folder')");
        if($sql)
        {
            ?>
            <div class="mi" style="color:#303030; font-size: 13px;">Successfully Entered!</div>
...
if(isset($_POST['registerss']))
{
    ...
    {
        $sql=mysqli_query($conn,"INSERT INTO `entrySRchemicals`(`Brand`, `Quantity`, `mlkg`, `Rate`, `Name`,`Image`) VALUES (' $brd','$Quan','$ml','$rat','$nam','$folder')");
        if($sql)
        {
            ?>
            <div class="mi" style="color:#303030; font-size: 13px;">Successfully Entered!</div>
...
<tr><td class="labelsss" id="fff">Product Image :</td><td><input type="file" required="required" name="imga" class="fields fff" size="25" value="Choose File" /></td></tr>
<center>

</center>
</table>
<tr><input type="submit" value="AR Chemicals" style="margin-left: 10px; padding:5px; width:100px; top:50px;" name="register" align="left" class="fields fg" /><input type="submit" style="margin-left: 10px; padding:5px; width:100px; top:50px;" value="LR Chemicals" name="registers" align="center" class="fields fg" /><input type="submit" style="margin-left: 10px; padding:5px; width:100px; top:50px;" value="SR Chemicals" name="registerss" align="right" class="fields fg" />
</tr>
</form>
<br>
